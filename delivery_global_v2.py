...
Uses the same within-group 90/10 split (seed 42) as the original predictions/
delivery, but trains with global-loss v2 and checkpoints by validation R_tot.
"""
...
EXPORT_DATASETS = {
    "point": os.path.join(ROOT, "adv_datasets", "cycle34_residual_dataset.pt"),
