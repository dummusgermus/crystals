"""Long local run: Graph Transformer on planar residual (1200 epochs).
...
Example::
    ...
    python train_transformer_planar_residual_1200.py
"""
...
EPOCHS = 1200
SCORE_LAST_N = 50
OUTPUT_JSON = os.path.join(ROOT, "transformer_planar_residual_1200_curves.json")
NAME = "planar_residual_c14c15"
...
def main() -> None:
    ...
    payload = {
        ...
        "notes": (
            "Long local stability run on planar residual with current defaults. "
